---
title: "Python Robotics - Making the Robot Move"
---
<link rel="stylesheet" href="../../python/common/sheet.css">

<table class="key_info">
<tr><td class="difficulty">Difficulty: <b>🌶🌶</b><i>🌶🌶🌶</i></td>
<td>Language: Python</td>
<td>Requires: Laptop with Thonny</td></tr>
</table>

In this worksheet you will learn how to make the robot move. You will learn how to make the robot move forwards and backwards, and how to make it turn left and right.

What is required:

- Ensure you have a robot kit
- The Raspberry Pi Pico and Motor controller should be wired. Mentors can help with this.
- The Raspberry Pi Pico's in the robots all have MicroPython installed.
- You should have a USB cable to connect the robot to your computer
- You need a laptop with Thonny installed

## Connecting the Raspberry Pi Pico to Thonny

Connect the Raspberry Pi Pico and launch Thonny.
In the bottom right of Thonny, look for Raspberry Pi Pico.

![Choosing The Pico In Thonny](thonny-choosing-pico-1.png)

![Choosing The Pico In Thonny](thonny-choosing-pico-2.png)
